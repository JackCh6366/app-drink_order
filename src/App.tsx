 ...
 */
function doGet(e) { /* ... 完整代碼已存放在 /index.html 內的設定教學中 ... */ }`;
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl w-full max-w-xl border border-white/50 shadow-2xl relative z-10 max-h-[90vh] overflow-y-auto animate-slide-up">
                    ...
                    <div className="bg-blue-50/60 p-4 rounded-xl border border-blue-100/50 flex gap-3 text-slate-700 text-xs">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="leading-relaxed text-slate-400 font-semibold">
                                雙擊 index.html 時也會記住您的 localStorage 網址設定！您可以一鍵複製 index.html 檔案發送給全公司使用。
                            </p>
                        </div>
                    </div>
                </div>
